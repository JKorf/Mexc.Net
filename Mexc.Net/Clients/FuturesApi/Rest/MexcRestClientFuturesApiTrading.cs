...
namespace Mexc.Net.Clients.FuturesApi
{
    ...
    internal class MexcRestClientFuturesApiTrading : IMexcRestClientFuturesApiTrading
    {
            ...
            CancellationToken ct = default)
        {
            ...
            parameters.Add("type", type, EnumSerialization.Number);
            ...
            parameters.Add("lossTrend", stopLossPriceType, EnumSerialization.Number);
            parameters.Add("profitTrend", takeProfitPriceType, EnumSerialization.Number);
            ...
            parameters.Add("bboTypeNum", limitOrderType, EnumSerialization.Number);
            parameters.Add("stpMode", stpMode, EnumSerialization.Number);
            ...
            CancellationToken ct = default)
        {
            ...
            parameters.Add("symbol", symbol);
            parameters.Add("side", side, EnumSerialization.Number);
            parameters.Add("orderType", orderType, EnumSerialization.Number);
            parameters.Add("vol", quantity);
            parameters.Add("leverage", leverage);
            parameters.Add("openType", marginType, EnumSerialization.Number);
            parameters.Add("triggerPrice", triggerPrice);
            parameters.Add("triggerType", triggerType, EnumSerialization.Number);
            parameters.Add("executeCycle", executeCycle, EnumSerialization.Number);
            parameters.Add("trend", triggerPriceType, EnumSerialization.Number);
            parameters.Add("price", price);
            ...
            CancellationToken ct = default)
        {
            ...
            parameters.Add("stopLossPrice", stopLossPrice);
            parameters.Add("takeProfitPrice", takeProfitPrice);
            parameters.Add("profitLossVolType", profitLossVolumeType, EnumSerialization.Number);
            parameters.Add("takeProfitVol", takeProfitVolume);
            parameters.Add("stopLossVol", stopLossVolume);
            parameters.Add("volType", volumeType, EnumSerialization.Number);
            ...
            parameters.Add("takeProfitType", takeProfitType, EnumSerialization.Number);
            parameters.Add("takeProfitOrderPrice", takeProfitOrderPrice);
            parameters.Add("stopLossType", stopLossType, EnumSerialization.Number);
            ...
            CancellationToken ct = default)
        {
            ...
            parameters.Add("leverage", leverage);
            parameters.Add("openType", marginType, EnumSerialization.Number);
            parameters.Add("trend", triggerType, EnumSerialization.Number);
            parameters.Add("backType", callbackType, EnumSerialization.Number);
