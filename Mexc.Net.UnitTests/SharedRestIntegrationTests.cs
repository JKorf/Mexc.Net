...
namespace Mexc.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IMexcRestClientSpotApiShared GetSpotRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddMexc(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IMexcRestClient>().SpotApi.SharedClient;
        }

        private IMexcRestClientFuturesApiShared GetFuturesRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddMexc(x => x.Rest.OutputOriginalData = true);
            collection.AddLogging(x =>
            ...
            var sp = collection.BuildServiceProvider();
            return sp.GetRequiredService<IMexcRestClient>().FuturesApi.SharedClient;
        }
