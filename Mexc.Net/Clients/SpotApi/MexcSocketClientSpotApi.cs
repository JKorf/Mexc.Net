...
namespace Mexc.Net.Clients.SpotApi
{
    ...
    internal partial class MexcSocketClientSpotApi : SocketApiClient, IMexcSocketClientSpotApi
    {
        ...
        {
            var subscription = new MexcSubscription<MexcUpdateTrades, MexcTradeUpdate>(_logger, symbols.Select(s => "spot@public.aggre.deals.v3.api.pb@100ms@" + s), x => handler(x.As(x.Data.Data)), false);
