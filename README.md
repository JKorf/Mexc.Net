...
[![Docs](https://img.shields.io/badge/Docs-Mexc.Net-1b7f50?style=for-the-badge)](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=Mexc.Net)
...
The [Mexc.Net documentation](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=Mexc.Net) is the main resource for installing, configuring, and using the library.

| Resource | Description |
|--|--|
| [Client guide](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=Mexc.Net) | Installation, REST and WebSocket clients, authentication, dependency injection, error handling, and advanced features |
| [Examples](https://cryptoexchange.jkorf.dev/docs/exchange-clients/examples?library=Mexc.Net) | Common REST and WebSocket operations |
| [API reference](https://cryptoexchange.jkorf.dev/docs/exchange-clients/reference?library=Mexc.Net) | Client interfaces, methods, and properties |
...
For more examples and explanations, continue with the [Mexc.Net documentation](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=Mexc.Net) or browse the [compilable repository examples](https://github.com/JKorf/Mexc.Net/tree/main/Examples).
...
## Release notes
* Version 6.7.0 - 24 Sep 2026
    * Updated CryptoExchange.Net to v13.0.0
    * Shared APIs
      * Added SharedApi V2 support
      * Added `.SharedApi` property to clients
      * Added `(I)MexcSharedApiClient` containing all V2 SharedApi references
      * Added `SharedApi` to `MexcOptions` to provide SharedApi related options
...
* Version 6.3.0 - 29 Jul 2026
    ...
    * Added TempMaxLeverage to MexcContract model
